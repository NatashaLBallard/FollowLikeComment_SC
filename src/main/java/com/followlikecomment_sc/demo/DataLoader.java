...
//
//
//        User user = new User("test@tes.com", "test", "Test", "TestLastName", true, "user", roleRepository.findRoleClassByRole("USER"));
//        user.setPassword(passwordEncoder.encode(user.getPassword()));
//        user.addRole(roleRepository.findByRole("USER"));
//        userRepository.save(user);
//
//
//        user = new  User("admin@adm.com", "password", "Admin", "AdminLastName", true, "admin", roleRepository.findRoleClassByRole("ADMIN"));
//        user.setPassword(passwordEncoder.encode(user.getPassword()));
